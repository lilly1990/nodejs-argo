...
const SUB_PATH = process.env.SUB_PATH || '127jhl';       // 订阅路径
...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || '1108.lilly2000.netlib.re';          // 固定隧道域名,留空即启用临时隧道
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiMTlhNTg1NTIxYTE5MGNlZjNhYzAxMmQ1YjI0NzIwNGYiLCJ0IjoiMGY5ZmI0ZDgtNjNmYi00NjFkLWFmYjQtOTcwMjg5MGRmY2M3IiwicyI6IllqRm1Oekk1WVRVdFpHTXdZaTAwTldZM0xXRm1PREF0WXpFM05HRTVOekUzTUdVNSJ9';              // 固定隧道密钥json或token,留空即启用临时隧道,json获取地址：https://json.zone.id
const ARGO_PORT = process.env.ARGO_PORT || 8001;            // 固定隧道端口,使用token需在cloudflare后台设置和这里一致
const CFIP = process.env.CFIP || 'cdns.doon.eu.org';        // 节点优选域名或优选ip  
const CFPORT = process.env.CFPORT || 443;                   // 节点优选域名或优选ip对应的端口
const NAME = process.env.NAME || '1108';                        // 节点名称
